...
if (isset($_SESSION['user'])) {
    ...
    $allPosts = $display->getAllUserPosts();
} else {
...
<body id="top">
    ...
    <div class="bgded top">
        ...
        <div id="pageintro" class="hoc clear">
            <article>
                <p>All Blogs</p>
                <p>All blogs(inlcuding the ones which are not approved.)</p>
                    ...
                    <?php foreach ($allPosts as $post): ?>
                        <div class="post">
                            <li class="one_third">
                                <figure>
                                    <?php
                                    // Check the post status and assign class accordingly
                                    if ($post['status'] == 1) {
                                        $class = 'approved';
                                    } else {
                                        $class = 'not-approved';
                                    ...
                                    ?>
                                    <a class="imgover <?php echo $class; ?>" href="blog-edit.php?id=<?php echo $post['id']; ?>">
                                    ...
                                    <figcaption>
                                        ...
                                        <div>
                                            ...
                                            $limitedContent = implode(' ', array_slice($words, 0, 15));
